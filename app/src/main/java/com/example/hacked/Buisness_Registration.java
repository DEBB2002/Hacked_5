...
public class Buisness_Registration extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = findViewById( R.id.Buisnessname);
            ...
            mAuth.createUserWithEmailAndPassword( email1, password1 ).addOnCompleteListener( new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText( Buisness_Registration.this, "User Created Successfully", Toast.LENGTH_SHORT ).show();
                        DatabaseReference databaseReference = firebaseDatabase.getReference().child( "Hotels" ).child( mAuth.getUid() );
                        ...
                        databaseReference.setValue( users ).addOnCompleteListener( new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText( Buisness_Registration.this, "Hotel Created data stored", Toast.LENGTH_SHORT ).show();
                                    // startActivity( new Intent(Register.this,Login.class) );


                                } else {
                                    progressDialog.dismiss();
                                    Toast.makeText( Buisness_Registration.this, "Bello", Toast.LENGTH_SHORT ).show();
                                }
